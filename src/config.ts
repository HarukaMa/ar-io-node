...
export const CDB64_REMOTE_SEMAPHORE_TIMEOUT_MS = env.positiveIntOrDefault(
...
export const ARWEAVE_PEER_CHUNK_GET_PEER_SELECTION_COUNT =
  env.positiveIntOrDefault('ARWEAVE_PEER_CHUNK_GET_PEER_SELECTION_COUNT', 10);

// Timeout for TX geometry resolution requests (getTxOffset/getTxField)
export const ARWEAVE_CHUNK_GET_GEOMETRY_TIMEOUT_MS = env.positiveIntOrDefault(
  'ARWEAVE_CHUNK_GET_GEOMETRY_TIMEOUT_MS',
  5000,
);

// Retry count for TX geometry resolution requests (getTxOffset/getTxField)
export const ARWEAVE_CHUNK_GET_GEOMETRY_RETRY_COUNT =
  env.nonNegativeIntOrDefault('ARWEAVE_CHUNK_GET_GEOMETRY_RETRY_COUNT', 2);
...
export const TRUSTED_ARNS_GATEWAY_URL = env.varOrDefault(
  ...
  'https://__NAME__.turbo-gateway.com',
);
